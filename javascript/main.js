...
*/
function goToIe() {
    if( confirm("Your browser version is too low, please go to download the latest version of the browser")){
        window.location.href = 'https://support.microsoft.com/en-us/help/17621/internet-explorer-downloads'
    }
}
...
;(function($) {
	...
	var responsiveMenu = function() {
        ...
        window.setTimeout("$('.btn-menu').on('click', function() {$('#mainnav-mobi').slideToggle(300);$(this).toggleClass('active');})",500);
